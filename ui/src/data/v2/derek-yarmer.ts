...
export const DEREK_YARMER_V2: CandidateFullV2 = {
  ...
  "issues": [
    {
      "id": "i-bond-and-capital-spending-1",
      "title": "Bond and Capital Spending",
      "stated": {
        "text": "His most prominent issue. He is the board's most vocal fiscal hawk, critici",
        "sourceIds": [
          "s-1",
          "s-4",
          "s-5",
  ...
  "socialResearchNote": "Social research is included as observed public behavior, not as a proxy for belief. Platforms/sources checked: USD 489 official pages, USD 489 meeting portal, Hays Post, Tiger Media Network, BoardDocs search results, HaysMed, Pawnee Valley Community Hospital, Great Bend Tribune, Campaign search, Professional profile search, Public social search. Harvest range: 2021-01-01 through 2026-05-11.",
  "sources": [
    {
      "id": "s-1",
      "tier": "primary",
