...
export const ALLEN_PARK_V2: CandidateFullV2 = {
  ...
  "education": "B.S. Industrial/Elementary Education, Fort Hays State University; M.S. School Administration, Fort Hays State University",
  ...
  "whereTheyWorship": "Public sources do not identify a current church affiliation for Allen Park. No church is cited.",
  "campaignFinance": {
    "totalRaised": "Not disclosed (school board races in Kansas do not require campaign finance filings at the county level)",
    "narrative": "Park stated during the 2023 campaign that he had not received money from outside the school district and that his support came from family, friends, and community members who care about kids and education. Any remaining expenses, he said, were paid personally.",
    "donors": [],
    "undisclosed": "Kansas school board candidates are not required to file campaign finance disclosures with the state or county. No donor-by-donor list was found in public records.",
