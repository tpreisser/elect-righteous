...
export const CHASE_LAPORTE_V2: CandidateFullV2 = {
  ...
  "socialResearchNote": "Social research is included as observed public behavior, not as a proxy for belief. Platforms/sources checked: X, Facebook, YouTube, Instagram, LinkedIn, Truth Social, Gab, Gettr, Substack, Reddit, TikTok, FEC, Election listings, Issue archives. Harvest range: 2022-06-24 through 2026-05-11.",
  "sources": [
    {
      "id": "s-1",
      "tier": "primary",
