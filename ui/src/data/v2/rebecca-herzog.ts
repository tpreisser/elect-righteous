...
export const REBECCA_HERZOG_V2: CandidateFullV2 = {
  ...
  "socialResearchNote": "Social research is included as observed public behavior, not as a proxy for belief. Platforms/sources checked: Ellis County Register of Deeds page, Ellis County staff directory, Kansas Register of Deeds Association, League of Kansas Municipalities, County budget books, Hays Post, Tiger Media Network, Election results, Public meeting/elected-official references, Facebook, X / Twitter, Instagram, Threads, TikTok, YouTube, LinkedIn, Bluesky, Substack, Medium, Reddit, Truth Social, Gab, Gettr, Public search. Harvest range: 2020-09-29 through 2026-05-11.",
  "sources": [
    {
      "id": "s-1",
      "tier": "secondary",
